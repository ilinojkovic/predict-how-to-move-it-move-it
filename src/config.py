...
train_config['save_checkpoints_every_epoch'] = 1  # TODO after how many epochs the trained model should be saved
train_config['n_keep_checkpoints'] = 1  # TODO how many saved checkpoints to keep
