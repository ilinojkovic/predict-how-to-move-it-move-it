...
train_config['max_seq_length'] = 25  # TODO specify for how many time steps you want to unroll the RNN
...
train_config['target_size'] = 75

train_config['learning_rate'] = 0.01  # TODO specify a learning rate (this is currently just a dummy value)
...
train_config['gradient_clip'] = 10  # TODO gradient clipping scalar
